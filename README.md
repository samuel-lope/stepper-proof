...
*(Nota: Para operação sem display físico, o Commander está configurado para ecoar feedbacks via Serial Monitor do PC, evitando travamentos do barramento I2C).*

...
- **Persistência Local:** 10 slots de macro EEPROM (32 chars cada) para armazenamento de comandos frequentes.
...
| `*` + `#` | **ENTER** | Envia comando. Se buffer vazio, reenvia o último comando. |
...
### Modos de Feedback
- **Display LCD**: Linha 1 exibe o comando em construção (`Cmd:` ou `[F] Cmd:` no modo Fast Act). Linha 2 exibe o feedback H8P traduzido com efeito marquee automático para mensagens longas.
